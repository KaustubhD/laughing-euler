...
Find the pair of pentagonal numbers, P<sub>j</sub> and P<sub>k</sub>, for which their sum and difference are pentagonal and D = |P<sub>k</sub> − P<sub>j</sub>| is minimised.

What is the value of D?

Eg.

1. ```pentagonNumbers()``` should return 5482660
